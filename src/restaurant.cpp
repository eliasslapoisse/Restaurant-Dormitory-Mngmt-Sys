...
// GETTERS (hours)
int Restaurant::getBR_OPEN()  { return BREAKFAST_OPEN; }
int Restaurant::getBR_CLOSE() { return BREAKFAST_CLOSE; }
int Restaurant::getLU_OPEN()  { return LUNCH_OPEN; }
int Restaurant::getLU_CLOSE() { return LUNCH_CLOSE; }
int Restaurant::getDI_OPEN()  { return DINNER_OPEN; }
int Restaurant::getDI_CLOSE() { return DINNER_CLOSE; }
